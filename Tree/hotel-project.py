...
class HOTEL_MANAGEMENT:
    def   init (self): 
        ...
        self.Message6.configure(foreground="#58e0a7") 
        self.Message6.configure(highlightbackground="#d9d9d9") 
        self.Message6.configure(highlightcolor="black") 
        self.Message6.configure(text='''Welcome To Apna Classes''') 
        ...
        self.Button2.configure(background="#1d356b") 
        self.Button2.configure(disabledforeground="#bfbfbf") 
        self.Button2.configure(font=font14) 
        self.Button2.configure(foreground="#a8b1c7") 
        ...
        self.Button3.configure(background="#1d356b") 
        self.Button3.configure(disabledforeground="#bfbfbf") 
        self.Button3.configure(font=font14) 
        self.Button3.configure(foreground="#a8b1c7") 
...
if __name__	== '  main__': GUUEST=HOTEL_MANAGEMENT()
